...
import { assets, Category, Style } from "@/data/assets";
    ...
    <div className="min-h-screen">
      ...
      <div className="container py-12">
        <div className="mb-10">
          ...
          <p className="text-muted-foreground text-lg">{assets.length} AI-generated assets, ready to ship.</p>
        </div>
        ...
        <div className="text-sm text-muted-foreground mb-6">
          Showing <span className="text-foreground font-medium">{filtered.length}</span> of {assets.length} assets
        </div>
